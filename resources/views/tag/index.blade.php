    ...
    <div class="admin-wrapper">
      ...
      <div class="admin-content">
        <div class="button-group">
          <a href="{{route('tag.create')}}" class="btn btn-big">Add Tag</a>
        </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{!! htmlspecialchars_decode($tag->name) !!}</td>
                <td><a href="{{route('tag.edit',$tag->id)}}" class="edit">edit</a></td>
                <td><form action="{{route('tag.destroy',$tag->id)}}" class="form-wrapper" method="post">
                        {{method_field('delete')}}
